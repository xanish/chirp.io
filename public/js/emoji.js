...
;(function() {
	...
	var emoji = function(){
		 ...
		 */
		self.img_sets = {
			'apple' : {'path' : 'https://cdnjs.cloudflare.com/ajax/libs/emojione/2.1.4/assets/png/', 'sheet' : '/emoji-data/sheet_apple_64.png', 'mask' : 1},
	...
	emoji.prototype.replacement = function(idx, actual, wrapper, variation, is_extra){
		...
		if (self.supports_css) {
			if (self.use_sheet && img.px != null && img.py != null){
				...
				return '<span class="emoji emoji-sizer" hspace="2px" style="background-image:url('+img.path+')"'+title+' data-codepoints="'+img.full_idx+'">'+text+'</span>'+extra;
			}
		}
		return '<img src="'+img.path+'" hspace="2px" class="emoji" data-codepoints="'+img.full_idx+'" '+title+'/>'+extra;
	};
	...
	emoji.prototype.data = {
		...
		"1f441-1f5e8":[["\uD83D\uDC41\uD83D\uDDE8"],"","",["eye-in-speech-bubble"],41,0,1,0],
