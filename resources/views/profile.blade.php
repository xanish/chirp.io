    ...
    <div id="feed">
      ...
      <div class="row padding-20-top-bottom">
        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-3">
          <img class="img-circle img-responsive profile-pic" src="{{ asset(Config::get('constants.avatars').$user->profile_image) }}" alt="">
        </div>
        <div class="col-lg-11 col-sm-11 col-md-11 col-sm-11 col-xs-9">
          ...
          <div class="image padding-20 hidden-xs">
            <img class="img-responsive" src="{{ asset(Config::get('constants.tweet_images').$tweet->tweet_image) }}" alt="">
          </div>
        </div>
